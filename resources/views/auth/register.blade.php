@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Tienda Gigants')])
                    ...
                    <div class="card card-login card-hidden mb-3">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="bmd-form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                @if ($errors->has('name'))
                                    <div id="name-error"
                                         class="error text-danger pl-3" for="name" style="display: block;">
                            ...
                            <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }} mt-3">
                                ...
                                @if ($errors->has('email'))
                                    <div id="email-error"
                                         class="error text-danger pl-3" for="email" style="display: block;">
                            ...
                            <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
                                ...
                                @if ($errors->has('password'))
                                    <div id="password-error"
                                         class="error text-danger pl-3" for="password" style="display: block;">
