@extends('layouts.main',['activePage'=>'caracteristicas','titlePage'=>'Agregar Promoción'])
@section('content')
    <div class="content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text"
                                               class="form-control"
                                               name="ini_date"
                                               placeholder="AAAA/MM/DD" value="{{ old('ini_date') }}">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text"
                                               class="form-control"
                                               name="fin_date"
                                               placeholder="AAAA/MM/DD" value="{{ old('fin_date') }}">
